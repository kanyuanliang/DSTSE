...
class Critic(nn.Module):
	""
	def __init__(self,linear1=[22,20,15,15,15,10,5,1],linear2=[int(22*4),int(22*4),int(22*3),int(22*3),int(22*3),int(22*3),int(22*2),int(22*2),int(22*1)]):
		""
	...
	def net1(self,x,layers1,layers2):
		...
		x=x[:,:,-3:]
		x=x.transpose(2,1)
		x=x.contiguous().view(-1,int(3*22))
		x=torch.cat((p,x),1)
		""
