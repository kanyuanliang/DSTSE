...
train_data=torch.load('data_of_dataset2/output/preextracted_traindata_for_fitting_model2.pt', map_location='cpu').to(device)
...
path='data_of_dataset2/output/fitting_model_for_dataset2.pt'
